...
<body>
    <div class="page ">
        ...
        <div class="sidebar">
            <div class="fix-sidebar">
                ...
                <ul>
                    ...
                    <li>
                    <a class="" href="farmer_msg.php">
                        <i class="fa-solid fa-comments fa-fw"></i>
                        <span>Messages</span>
                    </a>
                    </li>
                    <li>
                    <a class="active" href="farmer_shop.php">
        ...
        <div class="box1">
            ...
            <div class="head-box">
                <div class="title">
                    <a href="farmer.php" class="active">Store</a>
                    <a href="farmer.php" class="">Home</a>
